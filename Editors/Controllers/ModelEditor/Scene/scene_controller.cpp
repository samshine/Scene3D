...
#include "Views/Scene/scene_pivot_action.h"
...
SceneController::SceneController()
{
	...
	auto pivot_action = view->add_action<ScenePivotAction>();
	pivot_action->set_type(ScenePivotType::move);
	pivot_action->set_position(Vec3f(0.0f,0.0f, 0.0f));
