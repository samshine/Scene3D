...
namespace uicore { class ModelData; }
namespace uicore { class TerrainData; }
...
public:
	...
	static Physics3DShape terrain(const std::shared_ptr<uicore::TerrainData> &terrain_data, uicore::Mat4f &out_transform);
	static Physics3DShape model(const std::shared_ptr<uicore::ModelData> &model_data);
	static Physics3DShape scale_model(const Physics3DShape &base_model, uicore::Vec3f scale);
	static Physics3DShape gimpact_model(const std::shared_ptr<uicore::ModelData> &model_data);
