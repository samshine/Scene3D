...
Physics3DConstraint Physics3DConstraint::point_to_point(const Physics3DWorldPtr &world, const Physics3DObject &a, const Vec3f &pivot_in_a)
{
	btRigidBody &body_a = *btRigidBody::upcast(a.impl->object.get());

	Physics3DConstraint constraint;
	constraint.impl = std::shared_ptr<Physics3DConstraintImpl>(new Physics3DConstraintImpl(static_cast<Physics3DWorldImpl*>(world.get())));
	...
	static_cast<Physics3DWorldImpl*>(world.get())->dynamics_world->addConstraint(constraint.impl->constraint.get());

	return constraint;
}

Physics3DConstraint Physics3DConstraint::point_to_point(const Physics3DWorldPtr &world, const Physics3DObject &a, const Physics3DObject &b, const Vec3f &pivot_in_a, const Vec3f &pivot_in_b)
{
	btRigidBody &body_a = *btRigidBody::upcast(a.impl->object.get());
...
Physics3DConstraint Physics3DConstraint::hinge(const Physics3DWorldPtr &world, const Physics3DObject &a, const Vec3f &pivot_in_a, const Quaternionf &axis_in_a, bool use_reference_frame_a)
{
	btRigidBody &body_a = *btRigidBody::upcast(a.impl->object.get());
...
Physics3DConstraint Physics3DConstraint::hinge(const Physics3DWorldPtr &world, const Physics3DObject &a, const Physics3DObject &b, const Vec3f &pivot_in_a, const Vec3f &pivot_in_b, const Quaternionf &axis_in_a, const Quaternionf &axis_in_b, bool use_reference_frame_a)
{
	btRigidBody &body_a = *btRigidBody::upcast(a.impl->object.get());
	btRigidBody &body_b = *btRigidBody::upcast(b.impl->object.get());
...
Physics3DConstraint Physics3DConstraint::slider(const Physics3DWorldPtr &world, const Physics3DObject &a, const Physics3DObject &b, const Vec3f &pivot_in_a, const Vec3f &pivot_in_b, const Quaternionf &axis_in_a, const Quaternionf &axis_in_b, bool use_reference_frame_a)
{
	btRigidBody &body_a = *btRigidBody::upcast(a.impl->object.get());
	btRigidBody &body_b = *btRigidBody::upcast(b.impl->object.get());
...
Physics3DConstraint Physics3DConstraint::cone_twist(const Physics3DWorldPtr &world, const Physics3DObject &a, const Vec3f &pivot_in_a, const Quaternionf &axis_in_a)
{
	btRigidBody &body_a = *btRigidBody::upcast(a.impl->object.get());
...
Physics3DConstraint Physics3DConstraint::cone_twist(const Physics3DWorldPtr &world, const Physics3DObject &a, const Physics3DObject &b, const Vec3f &pivot_in_a, const Vec3f &pivot_in_b, const Quaternionf &axis_in_a, const Quaternionf &axis_in_b)
{
	btRigidBody &body_a = *btRigidBody::upcast(a.impl->object.get());
	btRigidBody &body_b = *btRigidBody::upcast(b.impl->object.get());
...
Physics3DConstraint Physics3DConstraint::six_degrees_of_freedom(const Physics3DWorldPtr &world, const Physics3DObject &a, const Physics3DObject &b, const Vec3f &pivot_in_a, const Vec3f &pivot_in_b, const Quaternionf &axis_in_a, const Quaternionf &axis_in_b, bool use_reference_frame_a)
{
	btRigidBody &body_a = *btRigidBody::upcast(a.impl->object.get());
	btRigidBody &body_b = *btRigidBody::upcast(b.impl->object.get());
