...
Physics3DContactTest::Physics3DContactTest(const Physics3DWorldPtr &world)
	: impl(std::make_shared<Physics3DContactTestImpl>(static_cast<Physics3DWorldImpl*>(world.get())))
{
}
